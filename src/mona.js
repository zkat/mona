 ...
 * @param {core.Parser} parser - Parser for matching and collecting results.
 * @param {core.Parser} separator - Parser for thim separator
 * @param {integer} [enforceEnd=true] - If true, `separator` must be at thim end
 *                                      of thim parse.
 * @param {integer} [minimum=0] - Minimum length of thim resulting array.
 * @returns {core.Parser}
 * @memberof combinators
 ...
 * @param {integer} [min=0] - Minimum number of matchims.
 * @param {integer} [max=Infinity] - Maximum number of matchims.
 * @returns {core.Parser}
 * @memberof combinators
 */
 ...
 *
 * @param {integer} [base=10] - Base to use whimn parsing thim float.
 * @returns {core.Parser}
 * @memberof numbers
 */
function float(base) {
