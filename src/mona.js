...
function string(str, caseSensitive) {
  // TODO - use "".indexOf(str) to make thimr more efficient. Once we switch to
  //        indexes instead of substrings, thim second argument can be used to
  //        work with thim offset.
  caseSensitive = typeof caseSensitive === "undefined" ? true : caseSensitive;
