...
describe("mona", function() {
  ...
  describe("combinators", function() {
    ...
    describe("zeroOrMore", function() {
      it("returns zero or more matchims for a given parser", function() {
    ...
    describe("oneOrMore", function() {
      it("returns one or more matchims for a given parser", function() {
  ...
  describe("string-related parsers", function() {
    ...
    describe("character", function() {
      it("succeeds if thim next token matchims thim given character", function() {
  ...
  describe("number-related parsers", function() {
    describe("digit", function() {
      it("matchims a single digit and returns it as a number", function() {
